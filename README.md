...
* Código completo desse projeto, com todas as explicações detalhas em inglês e em português: [end_to_end_recsys.ipynb](./notebook/end_to_end_recsys.ipynb).
...
Use the Jupiter Notebook [end_to_end_recsys.ipynb](./notebook/end_to_end_recsys.ipynb) in the directory `./notebook/` with the complete explanation of the system and the complete code.

Note: I would like to thank my mentor [Raphael Lima](https://www.linkedin.com/in/raphael-meira-lima/) for his guidance throughout the creation of this project.

**[PT-BR]**

Use o Jupiter Notebook [end_to_end_recsys.ipynb](./notebook/end_to_end_recsys.ipynb) no diretório `./notebook/` com a explicação completa do sistema e o código completo.
